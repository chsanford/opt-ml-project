...
run(Octopus(), oct_gd_1, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_gd_2, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_gd_3, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
# [GD] lr=0.13
...
run(Octopus(), oct_gdnoise_1, fixed_params={'lr':0.13, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_gdnoise_2, fixed_params={'lr':0.13, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_gdnoise_3, fixed_params={'lr':0.13, 'momentum':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
# [GD + noise] r=5, T=0
...
run(Octopus(), oct_agd_1, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_agd_2, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_agd_3, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
# [AGD] lr=0.07, momentum=0.7
...
run(Octopus(), oct_noise_1, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_noise_2, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_noise_3, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_noise_4, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':False, 'noise_eps': 0.1}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
# [AGD + noise] r=3, T=0
...
run(Octopus(), oct_NCE_1, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_r':0, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_NCE_2, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_r':0, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_NCE_3, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_r':0, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_NCE_4, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_r':0, 'noise_eps': 0.1}, max_epochs=150, num_runs=200, metric='second', eps=0.1, verbose=False)
# [AGD + NCE] s=4, robust for s=3.5~5
...
run(Octopus(), oct_all_1, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_eps':0.1, 'noise_r':3, 'noise_T':0}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Octopus(), oct_all_2, fixed_params={'lr':0.07, 'momentum':0.7, 'NCE':True, 'noise_eps':0.1, 'noise_r':3, 'noise_T':0}, max_epochs=150, num_runs=500, metric='second', eps=0.1, verbose=False)
# [AGD + noise + NCE] s=10
...
run(Cosine(), cos_gd_1, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=100, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_gd_2, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=100, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_gd_3, fixed_params={'noise_r':0, 'momentum':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=100, num_runs=200, metric='second', eps=0.1, verbose=False)
# [GD] lr=1.2
...
run(Cosine(), cos_gdnoise_1, fixed_params={'lr':1.2, 'momentum':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=1000, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_gdnoise_2, fixed_params={'lr':1.2, 'momentum':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=1000, metric='second', eps=0.1, verbose=False)
# [GD + noise] r=0.1, T=1
...
run(Cosine(), cos_agd_1, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_agd_2, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_agd_3, fixed_params={'noise_r':0, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=500, metric='second', eps=0.1, verbose=False)
# [AGD] lr=1.2, momentum=0.8
...
run(Cosine(), cos_noise_1, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_noise_2, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':False, 'noise_eps':0.1}, max_epochs=50, num_runs=500, metric='second', eps=0.1, verbose=False)
# [AGD + noise] r=0.1, T=0
...
run(Cosine(), cos_NCE_1, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':True, 'noise_r':0, 'noise_eps':0.1}, max_epochs=50, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_NCE_2, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':True, 'noise_r':0, 'noise_eps':0.1}, max_epochs=50, num_runs=200, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_NCE_3, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':True, 'noise_r':0, 'noise_eps':0.1}, max_epochs=50, num_runs=1000, metric='second', eps=0.1, verbose=False)
# [AGD + NCE] NCE_s=3
...
run(Cosine(), cos_all_1, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':True, 'noise_r':0.1, 'noise_T':0, 'noise_eps':0.1}, max_epochs=50, num_runs=500, metric='second', eps=0.1, verbose=False)
run(Cosine(), cos_all_2, fixed_params={'lr':1.2, 'momentum':0.8, 'NCE':True, 'noise_r':0.1, 'noise_T':0, 'noise_eps':0.1}, max_epochs=50, num_runs=1000, metric='second', eps=0.1, verbose=False)
# [AGD + noise + NCE] NCE_s=4
